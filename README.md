...
> Node.js implementation of the µTP module that libp2p uses, which implements the [abstract-connection]() interface for dial/listen.

Uses @mafintosh [utp](https://github.com/mafintosh/utp)
